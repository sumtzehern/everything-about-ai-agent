...
- For non-trivial changes: pause and ask if this is the most elegant solution
- If a fix feels hacky: rethink the approach
- Implement the elegant solution when necessary
- Skip over-optimization for simple, obvious fixes
...
- **Simplicity First**  
  Make every change as simple as possible. Minimize impact  

- **No Laziness**  
  Find root causes. Avoid temporary fixes. Maintain senior-level standards  

- **Minimal Impact**  
  Only touch what is necessary. Avoid introducing new issues  
